---
layout: default
title: A Media Literacy Guide (Stage 4 Original)
permalink: /stage-four/
---

*This page preserves the original Stage 4 submission of the guide. The
current, revised version lives at the [main guide](./).*
...
2. **Separate news from opinion.** Many publications run both. Look at the
   ...
   pieces aren't lies, but they're arguments, not reporting.
...
6. **Cross-check with at least one other outlet.** If a story is only being
   reported by sources on one side of the spectrum, that's information in
   itself. Use Ground News or just search the headline.
...
8. **Check the date and the update history.** Old stories get recycled on
   social media as if they're new. A "2019" tag on a story being shared as
   2026 news changes everything.
